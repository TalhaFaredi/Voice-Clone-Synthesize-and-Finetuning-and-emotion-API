...
from Spanish_f5tts.model import CFM, spanish_dit, Trainer, spanish_unett
from Spanish_f5tts.model.dataset import load_dataset
from Spanish_f5tts.model.utils import get_tokenizer
...
def main():
    ...
    checkpoint_path = str(files("Spanish_f5tts").joinpath(f"../Spanish_ckpts/{args.dataset_name}"))

    # Model parameters based on experiment name

    if args.exp_name == "F5TTS_v1_Base":
        wandb_resume_id = None
        model_cls = spanish_dit
        model_cfg = dict(
            dim=1024,
            depth=22,
            heads=16,
    ...
    if tokenizer == "custom":
        ...
        tokenizer_path1 = args.tokenizer_path
    else:
        tokenizer_path1 = args.dataset_name
    tokenizer_path=tokenizer_path1.replace("_pinyin","")
