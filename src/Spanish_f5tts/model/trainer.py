...
from Spanish_f5tts.model.dataset import DynamicBatchSampler, collate_fn
from Spanish_f5tts.model.utils import default, exists
...
class Trainer:
    ...
    def train(self, train_dataset: Dataset, num_workers=16, resumable_with_seed: int = None):
        if self.log_samples:
            from Spanish_f5tts.infer.utils_infer import cfg_strength, spanish_load_vocoder, nfe_step, sway_sampling_coef

            vocoder = spanish_load_vocoder(
