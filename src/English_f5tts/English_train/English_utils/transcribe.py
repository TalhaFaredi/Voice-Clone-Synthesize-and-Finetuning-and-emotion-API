...
import librosa
import torchaudio
from English_f5tts.model.utils import convert_char_to_pinyin
from datasets.arrow_writer import ArrowWriter
import numpy as np
from scipy.io import wavfile
from English_f5tts.infer.utils_infer import transcribe
...
def transcribe_all(name_project, audio_files, language, user_mode=False):
    ...
    for i, file_audio_path in enumerate(files_to_process):
        ...
        try:
            ...
            for chunk_idx, (chunk_audio, start_time, end_time) in enumerate(list_slicer_chunks):
                ...
                try:
                    text = transcribe(file_segment_path, language)
