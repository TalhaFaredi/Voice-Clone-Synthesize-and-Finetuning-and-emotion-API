...
from English_f5tts.model import CFM
from English_f5tts.model.dataset import DynamicBatchSampler, collate_fn
from English_f5tts.model.utils import default, exists
...
class Trainer:
    def __init__(
        ...
        self.checkpoint_path = default(checkpoint_path, "English_ckpts/test_f5-tts")
    ...
    def train(self, train_dataset: Dataset, num_workers=16, resumable_with_seed: int = None):
        if self.log_samples:
            from English_f5tts.infer.utils_infer import cfg_strength, load_vocoder, nfe_step, sway_sampling_coef
