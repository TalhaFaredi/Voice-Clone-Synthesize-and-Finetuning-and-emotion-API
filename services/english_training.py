...
def start_english_training(data):
    try:
        ...
        def train_target():
            try:
                from src.English_f5tts.English_train.English_utils.training import run_training
               
                for message in run_training(project_name):
