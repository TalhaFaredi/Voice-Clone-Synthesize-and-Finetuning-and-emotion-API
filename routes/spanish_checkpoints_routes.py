...
spanish_checkpoints_routes = Blueprint('spanish_checkpoints_routes', __name__)


@spanish_checkpoints_routes.route('/es/list-checkpoints', methods=['POST'])
def list_checkpoints_for_spanish_project():
    try:
